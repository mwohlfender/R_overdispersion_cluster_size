...
if (!(file.exists(path_results_sim_processed_model_one_v2)) | do_new_sim) {
  ...
  results <- data_sim_parameters_grid_model_one %>%
    ...
    mutate(n_divergent_transitions = 0,
           ...
           number_yearly_mutations_estimate = 0, number_yearly_mutations_lower_cred_int = 0, number_yearly_mutations_upper_cred_int = 0,
           min_number_yearly_mutations_Rhat = 0, max_number_yearly_mutations_Rhat = 0,
  ...
  write_csv(x = results, file = path_results_sim_processed_model_one_v2)
