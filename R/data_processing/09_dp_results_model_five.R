...
# read results of parameter estimations of model 5 ----

# Switzerland
if (file.exists(paste0(path_results_model_five_ch, "1.rds"))) {
  
  results_model_five_ch_2021_01 <- readRDS(paste0(path_results_model_five_ch, "1.rds"))
  
} else {
  
  results_model_five_ch_2021_01 <- 0
  
}

if (file.exists(paste0(path_results_model_five_ch, "2.rds"))) {
  
  results_model_five_ch_2021_02 <- readRDS(paste0(path_results_model_five_ch, "2.rds"))
  
} else {
  
  results_model_five_ch_2021_02 <- 0
  
}

if (file.exists(paste0(path_results_model_five_ch, "3.rds"))) {
  
  results_model_five_ch_2021_03 <- readRDS(paste0(path_results_model_five_ch, "3.rds"))
  
} else {
  
  results_model_five_ch_2021_03 <- 0
  
}

if (file.exists(paste0(path_results_model_five_ch, "4.rds"))) {
  
  results_model_five_ch_2021_04 <- readRDS(paste0(path_results_model_five_ch, "4.rds"))
  
} else {
  
  results_model_five_ch_2021_04 <- 0
  
}

if (file.exists(paste0(path_results_model_five_ch, "5.rds"))) {
  
  results_model_five_ch_2021_05 <- readRDS(paste0(path_results_model_five_ch, "5.rds"))
  
} else {
  
  results_model_five_ch_2021_05 <- 0
  
}

if (file.exists(paste0(path_results_model_five_ch, "6.rds"))) {
  
  results_model_five_ch_2021_06 <- readRDS(paste0(path_results_model_five_ch, "6.rds"))
  
} else {
  
  results_model_five_ch_2021_06 <- 0
  
}

if (file.exists(paste0(path_results_model_five_ch, "7.rds"))) {
  
  results_model_five_ch_2021_07 <- readRDS(paste0(path_results_model_five_ch, "7.rds"))
  
} else {
  
  results_model_five_ch_2021_07 <- 0
  
}

if (file.exists(paste0(path_results_model_five_ch, "8.rds"))) {
  
  results_model_five_ch_2021_08 <- readRDS(paste0(path_results_model_five_ch, "8.rds"))
  
} else {
  
  results_model_five_ch_2021_08 <- 0
  
}

if (file.exists(paste0(path_results_model_five_ch, "9.rds"))) {
  
  results_model_five_ch_2021_09 <- readRDS(paste0(path_results_model_five_ch, "9.rds"))
  
} else {
  
  results_model_five_ch_2021_09 <- 0
  
}

if (file.exists(paste0(path_results_model_five_ch, "10.rds"))) {
  
  results_model_five_ch_2021_10 <- readRDS(paste0(path_results_model_five_ch, "10.rds"))
  
} else {
  
  results_model_five_ch_2021_10 <- 0
  
}

if (file.exists(paste0(path_results_model_five_ch, "11.rds"))) {
  
  results_model_five_ch_2021_11 <- readRDS(paste0(path_results_model_five_ch, "11.rds"))
  
} else {
  
  results_model_five_ch_2021_11 <- 0
  
}

if (file.exists(paste0(path_results_model_five_ch, "12.rds"))) {
  
  results_model_five_ch_2021_12 <- readRDS(paste0(path_results_model_five_ch, "12.rds"))
  
} else {
  
  results_model_five_ch_2021_12 <- 0
  
}


# Denmark
if (file.exists(paste0(path_results_model_five_dk, "1.rds"))) {
  
  results_model_five_dk_2021_01 <- readRDS(paste0(path_results_model_five_dk, "1.rds"))
  
} else {
  
  results_model_five_dk_2021_01 <- 0
  
}

if (file.exists(paste0(path_results_model_five_dk, "2.rds"))) {
  
  results_model_five_dk_2021_02 <- readRDS(paste0(path_results_model_five_dk, "2.rds"))
  
} else {
  
  results_model_five_dk_2021_02 <- 0
  
}

if (file.exists(paste0(path_results_model_five_dk, "3.rds"))) {
  
  results_model_five_dk_2021_03 <- readRDS(paste0(path_results_model_five_dk, "3.rds"))
  
} else {
  
  results_model_five_dk_2021_03 <- 0
  
}

if (file.exists(paste0(path_results_model_five_dk, "4.rds"))) {
  
  results_model_five_dk_2021_04 <- readRDS(paste0(path_results_model_five_dk, "4.rds"))
  
} else {
  
  results_model_five_dk_2021_04 <- 0
  
}

if (file.exists(paste0(path_results_model_five_dk, "5.rds"))) {
  
  results_model_five_dk_2021_05 <- readRDS(paste0(path_results_model_five_dk, "5.rds"))
  
} else {
  
  results_model_five_dk_2021_05 <- 0
  
}

if (file.exists(paste0(path_results_model_five_dk, "6.rds"))) {
  
  results_model_five_dk_2021_06 <- readRDS(paste0(path_results_model_five_dk, "6.rds"))
  
} else {
  
  results_model_five_dk_2021_06 <- 0
  
}

if (file.exists(paste0(path_results_model_five_dk, "7.rds"))) {
  
  results_model_five_dk_2021_07 <- readRDS(paste0(path_results_model_five_dk, "7.rds"))
  
} else {
  
  results_model_five_dk_2021_07 <- 0
  
}

if (file.exists(paste0(path_results_model_five_dk, "8.rds"))) {
  
  results_model_five_dk_2021_08 <- readRDS(paste0(path_results_model_five_dk, "8.rds"))
  
} else {
  
  results_model_five_dk_2021_08 <- 0
  
}

if (file.exists(paste0(path_results_model_five_dk, "9.rds"))) {
  
  results_model_five_dk_2021_09 <- readRDS(paste0(path_results_model_five_dk, "9.rds"))
  
} else {
  
  results_model_five_dk_2021_09 <- 0
  
}

if (file.exists(paste0(path_results_model_five_dk, "10.rds"))) {
  
  results_model_five_dk_2021_10 <- readRDS(paste0(path_results_model_five_dk, "10.rds"))
  
} else {
  
  results_model_five_dk_2021_10 <- 0
  
}

if (file.exists(paste0(path_results_model_five_dk, "11.rds"))) {
  
  results_model_five_dk_2021_11 <- readRDS(paste0(path_results_model_five_dk, "11.rds"))
  
} else {
  
  results_model_five_dk_2021_11 <- 0
  
}

if (file.exists(paste0(path_results_model_five_dk, "12.rds"))) {
  
  results_model_five_dk_2021_12 <- readRDS(paste0(path_results_model_five_dk, "12.rds"))
  
} else {
  
  results_model_five_dk_2021_12 <- 0
  
}


# Germany
if (file.exists(paste0(path_results_model_five_de, "1.rds"))) {
  
  results_model_five_de_2021_01 <- readRDS(paste0(path_results_model_five_de, "1.rds"))
  
} else {
  
  results_model_five_de_2021_01 <- 0
  
}

if (file.exists(paste0(path_results_model_five_de, "2.rds"))) {
  
  results_model_five_de_2021_02 <- readRDS(paste0(path_results_model_five_de, "2.rds"))
  
} else {
  
  results_model_five_de_2021_02 <- 0
  
}

if (file.exists(paste0(path_results_model_five_de, "3.rds"))) {
  
  results_model_five_de_2021_03 <- readRDS(paste0(path_results_model_five_de, "3.rds"))
  
} else {
  
  results_model_five_de_2021_03 <- 0
  
}

if (file.exists(paste0(path_results_model_five_de, "4.rds"))) {
  
  results_model_five_de_2021_04 <- readRDS(paste0(path_results_model_five_de, "4.rds"))
  
} else {
  
  results_model_five_de_2021_04 <- 0
  
}

if (file.exists(paste0(path_results_model_five_de, "5.rds"))) {
  
  results_model_five_de_2021_05 <- readRDS(paste0(path_results_model_five_de, "5.rds"))
  
} else {
  
  results_model_five_de_2021_05 <- 0
  
}

if (file.exists(paste0(path_results_model_five_de, "6.rds"))) {
  
  results_model_five_de_2021_06 <- readRDS(paste0(path_results_model_five_de, "6.rds"))
  
} else {
  
  results_model_five_de_2021_06 <- 0
  
}

if (file.exists(paste0(path_results_model_five_de, "7.rds"))) {
  
  results_model_five_de_2021_07 <- readRDS(paste0(path_results_model_five_de, "7.rds"))
  
} else {
  
  results_model_five_de_2021_07 <- 0
  
}

if (file.exists(paste0(path_results_model_five_de, "8.rds"))) {
  
  results_model_five_de_2021_08 <- readRDS(paste0(path_results_model_five_de, "8.rds"))
  
} else {
  
  results_model_five_de_2021_08 <- 0
  
}

if (file.exists(paste0(path_results_model_five_de, "9.rds"))) {
  
  results_model_five_de_2021_09 <- readRDS(paste0(path_results_model_five_de, "9.rds"))
  
} else {
  
  results_model_five_de_2021_09 <- 0
  
}

if (file.exists(paste0(path_results_model_five_de, "10.rds"))) {
  
  results_model_five_de_2021_10 <- readRDS(paste0(path_results_model_five_de, "10.rds"))
  
} else {
  
  results_model_five_de_2021_10 <- 0
  
}

if (file.exists(paste0(path_results_model_five_de, "11.rds"))) {
  
  results_model_five_de_2021_11 <- readRDS(paste0(path_results_model_five_de, "11.rds"))
  
} else {
  
  results_model_five_de_2021_11 <- 0
  
}

if (file.exists(paste0(path_results_model_five_de, "12.rds"))) {
  
  results_model_five_de_2021_12 <- readRDS(paste0(path_results_model_five_de, "12.rds"))
  
} else {
  
  results_model_five_de_2021_12 <- 0
...
list_results_model_five_ch_2021 <- list(results_model_five_ch_2021_01, results_model_five_ch_2021_02, results_model_five_ch_2021_03, 
                                       results_model_five_ch_2021_04, results_model_five_ch_2021_05, results_model_five_ch_2021_06,
                                       results_model_five_ch_2021_07, results_model_five_ch_2021_08, results_model_five_ch_2021_09,
                                       results_model_five_ch_2021_10, results_model_five_ch_2021_11, results_model_five_ch_2021_12)

list_results_model_five_dk_2021 <- list(results_model_five_dk_2021_01, results_model_five_dk_2021_02, results_model_five_dk_2021_03,
                                       results_model_five_dk_2021_04, results_model_five_dk_2021_05, results_model_five_dk_2021_06,
                                       results_model_five_dk_2021_07, results_model_five_dk_2021_08, results_model_five_dk_2021_09, 
                                       results_model_five_dk_2021_10, results_model_five_dk_2021_11, results_model_five_dk_2021_12)

list_results_model_five_de_2021 <- list(results_model_five_de_2021_01, results_model_five_de_2021_02, results_model_five_de_2021_03,
                                       results_model_five_de_2021_04, results_model_five_de_2021_05, results_model_five_de_2021_06,
                                       results_model_five_de_2021_07, results_model_five_de_2021_08, results_model_five_de_2021_09, 
                                       results_model_five_de_2021_10, results_model_five_de_2021_11, results_model_five_de_2021_12)


# create summary of results of parameter estimations of model 5 ----
results_model_five_ch_dk_de_2021_months <- data.frame(matrix(data = 0, nrow = 36, ncol = 23))
names(results_model_five_ch_dk_de_2021_months) <- c("month", "country", "sequencing_proba", 
...
results_model_five_ch_dk_de_2021_months <- results_model_five_ch_dk_de_2021_months %>%
...
results_model_five_n_divergent <- data.frame(matrix(data = 0, nrow = 36, ncol = 3))
names(results_model_five_n_divergent) <- c("month", "country", "n_divergent")

results_model_five_n_divergent <- results_model_five_n_divergent %>%
  mutate(month = rep(x=1:12, times=3),
         country = rep(x=c("Switzerland", "Denmark", "Germany"), each=12))
...
for(ii in 1:12) {
  ...
  results_ii <- list_results_model_five_ch_2021[[ii]]
  
  if (!(is.numeric(results_ii))) {
    
    results_model_five_ch_dk_de_2021_months$R_estimate[ii] <- get_posterior_mean(results_ii, par = c("R"))[, "mean-all chains"]
    results_model_five_ch_dk_de_2021_months$R_lower_cred_int[ii] <- as.data.frame(summary(results_ii)[[1]])[c("R"), "2.5%"]
    results_model_five_ch_dk_de_2021_months$R_upper_cred_int[ii] <- as.data.frame(summary(results_ii)[[1]])[c("R"), "97.5%"]
    results_model_five_ch_dk_de_2021_months$R_Rhat[ii] <- as.data.frame(summary(results_ii)[[1]])[c("R"), "Rhat"]
    
    results_model_five_ch_dk_de_2021_months$k_estimate[ii] <- get_posterior_mean(results_ii, par = c("k"))[, "mean-all chains"]
    results_model_five_ch_dk_de_2021_months$k_lower_cred_int[ii] <- as.data.frame(summary(results_ii)[[1]])[c("k"), "2.5%"]
    results_model_five_ch_dk_de_2021_months$k_upper_cred_int[ii] <- as.data.frame(summary(results_ii)[[1]])[c("k"), "97.5%"]
    results_model_five_ch_dk_de_2021_months$k_Rhat[ii] <- as.data.frame(summary(results_ii)[[1]])[c("k"), "Rhat"]
    
    results_model_five_ch_dk_de_2021_months$mutation_proba_estimate[ii] <- get_posterior_mean(results_ii, par = c("mutation_proba"))[, "mean-all chains"]
    results_model_five_ch_dk_de_2021_months$mutation_proba_lower_cred_int[ii] <- as.data.frame(summary(results_ii)[[1]])[c("mutation_proba"), "2.5%"]
    results_model_five_ch_dk_de_2021_months$mutation_proba_upper_cred_int[ii] <- as.data.frame(summary(results_ii)[[1]])[c("mutation_proba"), "97.5%"]
    results_model_five_ch_dk_de_2021_months$mutation_proba_Rhat[ii] <- as.data.frame(summary(results_ii)[[1]])[c("mutation_proba"), "Rhat"]
    
    results_model_five_ch_dk_de_2021_months$testing_proba_estimate[ii] <- get_posterior_mean(results_ii, par = c("testing_proba"))[, "mean-all chains"]
    results_model_five_ch_dk_de_2021_months$testing_proba_lower_cred_int[ii] <- as.data.frame(summary(results_ii)[[1]])[c("testing_proba"), "2.5%"]
    results_model_five_ch_dk_de_2021_months$testing_proba_upper_cred_int[ii] <- as.data.frame(summary(results_ii)[[1]])[c("testing_proba"), "97.5%"]
    results_model_five_ch_dk_de_2021_months$testing_proba_Rhat[ii] <- as.data.frame(summary(results_ii)[[1]])[c("testing_proba"), "Rhat"]
    
    results_model_five_ch_dk_de_2021_months$detection_proba_estimate[ii] <- get_posterior_mean(results_ii, par = c("detection_proba"))[, "mean-all chains"]
    results_model_five_ch_dk_de_2021_months$detection_proba_lower_cred_int[ii] <- as.data.frame(summary(results_ii)[[1]])[c("detection_proba"), "2.5%"]
    results_model_five_ch_dk_de_2021_months$detection_proba_upper_cred_int[ii] <- as.data.frame(summary(results_ii)[[1]])[c("detection_proba"), "97.5%"]
    results_model_five_ch_dk_de_2021_months$detection_proba_Rhat[ii] <- as.data.frame(summary(results_ii)[[1]])[c("detection_proba"), "Rhat"]
    
    results_model_five_n_divergent$n_divergent[ii] <- get_num_divergent(results_ii)
    
    ggsave(plot = rstan::traceplot(results_ii, inc_warmup = TRUE),
           filename = paste0("plots/switzerland/model_five/traceplot_", ii, ".png"),
...
for(ii in 13:24) {
  ...
  results_ii <- list_results_model_five_dk_2021[[ii-12]]
  ...
  if (!(is.numeric(results_ii))) {
    ...
    ggsave(plot = rstan::traceplot(results_ii, inc_warmup = TRUE),
           filename = paste0("plots/denmark/model_five/traceplot_", ii - 12, ".png"),
           width = 5, height = 5, units = c("in"))
...
for(ii in 25:36) {
  ...
  results_ii <- list_results_model_five_de_2021[[ii-24]]
  ...
  if (!(is.numeric(results_ii))) {
    ...
    ggsave(plot = rstan::traceplot(results_ii, inc_warmup = TRUE),
           filename = paste0("plots/germany/model_five/traceplot_", ii - 24, ".png"),
           width = 5, height = 5, units = c("in"))
...
# save `results_model_five_ch_dk_de_2021_months` as csv file ----
write_csv(results_model_five_ch_dk_de_2021_months, file = path_results_model_five_ch_dk_de_processed)



# run some checks ----
results_model_five_checks_ch_dk_de <- cbind(results_model_five_n_divergent,
                                           results_model_five_ch_dk_de_2021_months %>%
                                             dplyr::select(c("R_Rhat", "k_Rhat", "mutation_proba_Rhat", "testing_proba_Rhat", "detection_proba_Rhat")))

results_model_five_checks_ch <- results_model_five_checks_ch_dk_de %>% filter(country == "Switzerland")
results_model_five_checks_dk <- results_model_five_checks_ch_dk_de %>% filter(country == "Denmark")
...
remove(results_model_five_ch_2021_01, results_model_five_ch_2021_02, results_model_five_ch_2021_03, 
       results_model_five_ch_2021_04, results_model_five_ch_2021_05, results_model_five_ch_2021_06,
       results_model_five_ch_2021_07, results_model_five_ch_2021_08, results_model_five_ch_2021_09,
       results_model_five_ch_2021_10, results_model_five_ch_2021_11, results_model_five_ch_2021_12)

remove(results_model_five_dk_2021_01, results_model_five_dk_2021_02, results_model_five_dk_2021_03,
       results_model_five_dk_2021_04, results_model_five_dk_2021_05, results_model_five_dk_2021_06,
       results_model_five_dk_2021_07, results_model_five_dk_2021_08, results_model_five_dk_2021_09, 
       results_model_five_dk_2021_10, results_model_five_dk_2021_11, results_model_five_dk_2021_12)

remove(results_model_five_de_2021_01, results_model_five_de_2021_02, results_model_five_de_2021_03,
       results_model_five_de_2021_04, results_model_five_de_2021_05, results_model_five_de_2021_06,
       results_model_five_de_2021_07, results_model_five_de_2021_08, results_model_five_de_2021_09, 
       results_model_five_de_2021_10, results_model_five_de_2021_11, results_model_five_de_2021_12)

remove(list_results_model_five_ch_2021, list_results_model_five_dk_2021, list_results_model_five_de_2021)
