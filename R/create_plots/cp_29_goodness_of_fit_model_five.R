...
data_distribution_mean_ch_dk_de_2021_months <- read_csv(file = path_results_goodness_fit_mean_model_five_ch_dk_de)
data_distribution_low_ch_dk_de_2021_months <- read_csv(file = path_results_goodness_fit_low_model_five_ch_dk_de)
data_distribution_high_ch_dk_de_2021_months <- read_csv(file = path_results_goodness_fit_high_model_five_ch_dk_de)
...
plot_goodness_fit_model_five_ch <- ggplot() +
  ...
  scale_y_continuous(name = "Probability",
                     breaks = c(1e-9, 1e-7, 1e-5, 0.001, 0.1),
...
plot_goodness_fit_model_five_dk <- ggplot() +
...
plot_goodness_fit_model_five_de <- ggplot() +
