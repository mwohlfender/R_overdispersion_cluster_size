...
# simulation study
# create results of simulation study using model one
...
results_v1 <- read_csv(path_results_sim_processed_model_one_v1)
...
data_results_0 <- cbind(data_sim_parameters_grid_model_one, results_v1)
...
for (ii in 1:nrow(data_plots)) {
  ...
  if (nrow(data_results_filtered) >= 1) {
    ...
    data_plots$min_t_total[ii] <- min(data_results_filtered$t_total)
    data_plots$max_t_total[ii] <- max(data_results_filtered$t_total)
...
for (ii in 1:length(n_clusters_range)) {
  ...
  for (jj in 1:length(max_cluster_size_range)) {
    ...
    plot_sim_model_one_R_rmse <- ggplot(data = data_plot_completed_estimates_temp) +
    ...
    ggsave(plot = plot_sim_model_one_R_rmse,
           filename = paste0("plots/simulation/model_one/plot_sim_model_one_R_rmse_", n_clusters_range[ii], "_", max_cluster_size_range[jj], ".pdf"),
    ...
    # plot_sim_model_one_R_cv <- ggplot(data = data_plot_completed_estimates_temp) +
    ...
    ggsave(plot = plot_sim_model_one_R_cv,
           filename = paste0("plots/simulation/model_one/plot_sim_model_one_R_cv_", n_clusters_range[ii], "_", max_cluster_size_range[jj], ".pdf"),
           width = image_width_in, height = image_width_in/ratio_width_height, units = c("in"), bg = "white")
    ...
    plot_sim_model_one_R_coverage <- ggplot(data = data_plot_completed_estimates_temp) +
    ...
    ggsave(plot = plot_sim_model_one_R_coverage,
           filename = paste0("plots/simulation/model_one/plot_sim_model_one_R_coverage_", n_clusters_range[ii], "_", max_cluster_size_range[jj], ".pdf"),
           width = image_width_in, height = image_width_in/ratio_width_height, units = c("in"), bg = "white")
    ...
    plot_sim_model_one_k_rmse <- ggplot(data = data_plot_completed_estimates_temp) +
    ...
    ggsave(plot = plot_sim_model_one_k_rmse,
           filename = paste0("plots/simulation/model_one/plot_sim_model_one_k_rmse_", n_clusters_range[ii], "_", max_cluster_size_range[jj], ".pdf"),
           width = image_width_in, height = image_width_in/ratio_width_height, units = c("in"), bg = "white")
    ...
    # plot_sim_model_one_k_cv <- ggplot(data = data_plot_completed_estimates_temp) +
    ...
    ggsave(plot = plot_sim_model_one_k_cv,
           filename = paste0("plots/simulation/model_one/plot_sim_model_one_k_cv_", n_clusters_range[ii], "_", max_cluster_size_range[jj], ".pdf"),
           width = image_width_in, height = image_width_in/ratio_width_height, units = c("in"), bg = "white")
    ...
    plot_sim_model_one_k_coverage <- ggplot(data = data_plot_completed_estimates_temp) +
    ...
    ggsave(plot = plot_sim_model_one_k_coverage,
           filename = paste0("plots/simulation/model_one/plot_sim_model_one_k_coverage_", n_clusters_range[ii], "_", max_cluster_size_range[jj], ".pdf"),
           width = image_width_in, height = image_width_in/ratio_width_height, units = c("in"), bg = "white")
    ...
    plot_sim_model_one_testing_proba_rmse <- ggplot(data = data_plot_completed_estimates_temp) +
    ...
    ggsave(plot = plot_sim_model_one_testing_proba_rmse,
           filename = paste0("plots/simulation/model_one/plot_sim_model_one_testing_proba_rmse_", n_clusters_range[ii], "_", max_cluster_size_range[jj], ".pdf"),
           width = image_width_in, height = image_width_in/ratio_width_height, units = c("in"), bg = "white")
    ...
    # plot_sim_model_one_testing_proba_cv <- ggplot(data = data_plot_completed_estimates_temp) +
    ...
    ggsave(plot = plot_sim_model_one_testing_proba_cv,
           filename = paste0("plots/simulation/model_one/plot_sim_model_one_testing_proba_cv_", n_clusters_range[ii], "_", max_cluster_size_range[jj], ".pdf"),
           width = image_width_in, height = image_width_in/ratio_width_height, units = c("in"), bg = "white")
    ...
    plot_sim_model_one_testing_proba_coverage <- ggplot(data = data_plot_completed_estimates_temp) +
    ...
    ggsave(plot = plot_sim_model_one_testing_proba_coverage,
           filename = paste0("plots/simulation/model_one/plot_sim_model_one_testing_proba_coverage_", n_clusters_range[ii], "_", max_cluster_size_range[jj], ".pdf"),
           width = image_width_in, height = image_width_in/ratio_width_height, units = c("in"), bg = "white")
    ...
    plot_sim_model_one_n_estimates <- ggplot(data = data_plot_all_estimates_temp) +
    ...
    ggsave(plot = plot_sim_model_one_n_estimates,
           filename = paste0("plots/simulation/model_one/plot_sim_model_one_n_estimates_", n_clusters_range[ii], "_", max_cluster_size_range[jj], ".pdf"),
           width = image_width_in, height = image_width_in/ratio_width_height, units = c("in"), bg = "white")
    ...
    plot_sim_model_one_run_time <- ggplot(data = data_plot_completed_estimates_temp) +
    ...
    # ggsave(plot = plot_sim_model_one_run_time,
    #        filename = paste0("plots/simulation/model_one/plot_sim_model_one_run_time_", n_clusters_range[ii], "_", max_cluster_size_range[jj], ".pdf"),
    #        width = image_width_in, height = image_width_in/ratio_width_height, units = c("in"), bg = "white")
    
    # plot grid of `plot_sim_model_one_R_rmse`, `plot_sim_model_one_k_rmse` and `plot_sim_model_one_testing_proba_rmse`
    
    plot_sim_model_one_R_k_testing_proba_rmse <- plot_grid(plot_sim_model_one_R_rmse +
                                                   theme(axis.text=element_text(size=7, color="black"),
                                                         legend.text=element_text(size=7),
                                                         plot.margin = unit(c(0,0,0,0), "in")),
                                                 plot_sim_model_one_k_rmse +
                                                   theme(axis.text=element_text(size=7, color="black"),
                                                         legend.text=element_text(size=7),
                                                         plot.margin = unit(c(0,0,0,0), "in")),
                                                 plot_sim_model_one_testing_proba_rmse +
                                                   theme(axis.text=element_text(size=7, color="black"),
                                                         legend.text=element_text(size=7),
                                                         plot.margin = unit(c(0,0,0,0), "in")),
                                                 labels = c("A", "B", "C"),
    ...
    ggsave(plot = plot_sim_model_one_R_k_testing_proba_rmse,
           filename = paste0("plots/simulation/model_one/plot_sim_model_one_R_k_testing_proba_rmse_", n_clusters_range[ii], "_", max_cluster_size_range[jj], ".pdf"),
           width = 7.3, height = 10.7, units = c("in"), bg = "white")
    
    # plot grid of `plot_sim_model_one_R_cv`, `plot_sim_model_one_k_cv` and `plot_sim_model_one_testing_proba_cv`
    legend_cv <- get_legend(plot_sim_model_one_R_cv)
    
    plot_sim_model_one_R_k_testing_proba_cv <- plot_grid(plot_sim_model_one_R_cv +
                                                 guides(fill = "none") +
                                                 theme(plot.margin = unit(c(0,0,0.1,0), "in")),
                                               plot_sim_model_one_k_cv +
                                                 guides(fill = "none") +
                                                 theme(plot.margin = unit(c(0,0,0.1,0), "in")),
                                               plot_sim_model_one_testing_proba_cv +
                                                 guides(fill = "none") +
                                                 theme(plot.margin = unit(c(0,0,0.1,0), "in")),
                                               as_ggplot(legend_cv),
                                               labels = c("A", "B", "C", ""),
    ...
    ggsave(plot = plot_sim_model_one_R_k_testing_proba_cv,
           filename = paste0("plots/simulation/model_one/plot_sim_model_one_R_k_testing_proba_cv_", n_clusters_range[ii], "_", max_cluster_size_range[jj], ".pdf"),
           width = 7.3, height = 10.7, units = c("in"), bg = "white")
    
    # plot grid of `plot_sim_model_one_R_coverage`, `plot_sim_model_one_k_coverage` and `plot_sim_model_one_testing_proba_coverage`
    legend_coverage <- get_legend(plot_sim_model_one_R_coverage)
    
    plot_sim_model_one_R_k_testing_proba_coverage <- plot_grid(plot_sim_model_one_R_coverage +
                                                       guides(fill = "none") +
                                                       theme(plot.margin = unit(c(0,0,0,0), "in")),
                                                     plot_sim_model_one_k_coverage +
                                                       guides(fill = "none") +
                                                       theme(plot.margin = unit(c(0,0,0,0), "in")),
                                                     plot_sim_model_one_testing_proba_coverage +
                                                       guides(fill = "none") +
                                                       theme(plot.margin = unit(c(0,0,0,0), "in")),
    ...
    ggsave(plot = plot_sim_model_one_R_k_testing_proba_coverage,
           filename = paste0("plots/simulation/model_one/plot_sim_model_one_R_k_testing_proba_coverage_", n_clusters_range[ii], "_", max_cluster_size_range[jj], ".pdf"),
           width = 7.3, height = 10.7, units = c("in"), bg = "white")
...
for (ii in 1:length(n_clusters_range)) {
  ...
  for (jj in 1:length(max_cluster_size_range)) {
    ...
    plot_sim_model_one_pooled_R <- ggplot(data = data_plot_R) +
    ...
    ggsave(plot = plot_sim_model_one_pooled_R,
           filename = paste0("plots/simulation/model_one/plot_sim_model_one_R_pooled_", n_clusters_range[ii], "_", max_cluster_size_range[jj], ".pdf"),
           width = image_width_in, height = image_width_in/ratio_width_height, units = c("in"), bg = "white")
    ...
    plot_sim_model_one_pooled_k <- ggplot(data = data_plot_k) +
    ...
    ggsave(plot = plot_sim_model_one_pooled_k,
           filename = paste0("plots/simulation/model_one/plot_sim_model_one_k_pooled_", n_clusters_range[ii], "_", max_cluster_size_range[jj], ".pdf"),
           width = image_width_in, height = image_width_in/ratio_width_height, units = c("in"), bg = "white")
    ...
    plot_sim_model_one_pooled_testing_proba <- ggplot(data = data_plot_testing_proba) +
    ...
    ggsave(plot = plot_sim_model_one_pooled_testing_proba,
           filename = paste0("plots/simulation/model_one/plot_sim_model_one_testing_proba_pooled_", n_clusters_range[ii], "_", max_cluster_size_range[jj], ".pdf"),
           width = image_width_in, height = image_width_in/ratio_width_height, units = c("in"), bg = "white")
    
    
    # plot grid of `plot_sim_model_one_pooled_R`, `plot_sim_model_one_pooled_k` and `plot_sim_model_one_pooled_testing_proba`
    legend_sequencing_proba <- get_legend(plot_sim_model_one_pooled_R)
    
    plot_grid_sim_pooled_R_k_testing_proba <- plot_grid(plot_sim_model_one_pooled_R +
                                                          guides(color = "none") +
                                                        ...
                                                        plot_sim_model_one_pooled_k +
                                                          guides(color = "none") +
                                                          theme(plot.margin = unit(c(0,0,0.1,0.1), "in"),
                                                                axis.text.x = element_text(size = 4.5, color="black"),
                                                                axis.text.y = element_text(size = 4.5, color="black")),
                                                        plot_sim_model_one_pooled_testing_proba +
                                                          guides(color = "none") +
                                                          theme(plot.margin = unit(c(0,0,0.1,0.1), "in"),
                                                                axis.text.x = element_text(size = 4.5, color="black"),
                                                                axis.text.y = element_text(size = 4.5, color="black")),
    ...
    ggsave(plot = plot_grid_sim_pooled_R_k_testing_proba,
           filename = paste0("plots/simulation/model_one/plot_sim_model_one_R_k_testing_proba_pooled_", n_clusters_range[ii], "_", max_cluster_size_range[jj], ".pdf"),
           width = 7.3, height = 10.7, units = c("in"), bg = "white")
