...
for (ii in 1:length(n_clusters_range)) {
  ...
  for (jj in 1:length(max_cluster_size_range)) {
    ...
    plot_sim_model_five_R_rmse <- ggplot(data = data_plot_completed_estimates_temp) +
    ...
    ggsave(plot = plot_sim_model_five_R_rmse,
    ...
    # plot_sim_model_five_R_cv <- ggplot(data = data_plot_completed_estimates_temp) +
    ...
    ggsave(plot = plot_sim_model_five_R_cv,
    ...
    plot_sim_model_five_R_coverage <- ggplot(data = data_plot_completed_estimates_temp) +
    ...
    ggsave(plot = plot_sim_model_five_R_coverage,
    ...
    plot_sim_model_five_k_rmse <- ggplot(data = data_plot_completed_estimates_temp) +
    ...
    ggsave(plot = plot_sim_model_five_k_rmse,
    ...
    # plot_sim_model_five_k_cv <- ggplot(data = data_plot_completed_estimates_temp) +
    ...
    ggsave(plot = plot_sim_model_five_k_cv,
    ...
    plot_sim_model_five_k_coverage <- ggplot(data = data_plot_completed_estimates_temp) +
    ...
    ggsave(plot = plot_sim_model_five_k_coverage,
    ...
    plot_sim_model_five_testing_proba_rmse <- ggplot(data = data_plot_completed_estimates_temp) +
    ...
    ggsave(plot = plot_sim_model_five_testing_proba_rmse,
    ...
    # plot_sim_model_five_testing_proba_cv <- ggplot(data = data_plot_completed_estimates_temp) +
    ...
    ggsave(plot = plot_sim_model_five_testing_proba_cv,
    ...
    plot_sim_model_five_testing_proba_coverage <- ggplot(data = data_plot_completed_estimates_temp) +
    ...
    ggsave(plot = plot_sim_model_five_testing_proba_coverage,
    ...
    plot_sim_model_five_n_estimates <- ggplot(data = data_plot_all_estimates_temp) +
    ...
    ggsave(plot = plot_sim_model_five_n_estimates,
    ...
    plot_sim_model_five_run_time <- ggplot(data = data_plot_completed_estimates_temp) +
    ...
    # ggsave(plot = plot_sim_model_five_run_time,
    ...
    # plot grid of `plot_sim_model_five_R_rmse`, `plot_sim_model_five_k_rmse` and `plot_sim_model_five_testing_proba_rmse`
    
    plot_sim_model_five_R_k_testing_proba_rmse <- plot_grid(plot_sim_model_five_R_rmse +
                                                   theme(axis.text=element_text(size=7, color="black"),
                                                         legend.text=element_text(size=7),
                                                         plot.margin = unit(c(0,0,0,0), "in")),
                                                 plot_sim_model_five_k_rmse +
                                                   theme(axis.text=element_text(size=7, color="black"),
                                                         legend.text=element_text(size=7),
                                                         plot.margin = unit(c(0,0,0,0), "in")),
                                                 plot_sim_model_five_testing_proba_rmse +
                                                   theme(axis.text=element_text(size=7, color="black"),
                                                         legend.text=element_text(size=7),
                                                         plot.margin = unit(c(0,0,0,0), "in")),
                                                 labels = c("A", "B", "C"),
    ...
    ggsave(plot = plot_sim_model_five_R_k_testing_proba_rmse,
    ...
    # plot grid of `plot_sim_model_five_R_cv`, `plot_sim_model_five_k_cv` and `plot_sim_model_five_testing_proba_cv`
    legend_cv <- get_legend(plot_sim_model_five_R_cv)
    
    plot_sim_model_five_R_k_testing_proba_cv <- plot_grid(plot_sim_model_five_R_cv +
                                                 guides(fill = "none") +
                                                 theme(plot.margin = unit(c(0,0,0.1,0), "in")),
                                               plot_sim_model_five_k_cv +
                                                 guides(fill = "none") +
                                                 theme(plot.margin = unit(c(0,0,0.1,0), "in")),
                                               plot_sim_model_five_testing_proba_cv +
                                                 guides(fill = "none") +
                                                 theme(plot.margin = unit(c(0,0,0.1,0), "in")),
                                               as_ggplot(legend_cv),
                                               labels = c("A", "B", "C", ""),
    ...
    ggsave(plot = plot_sim_model_five_R_k_testing_proba_cv,
    ...
    # plot grid of `plot_sim_model_five_R_coverage`, `plot_sim_model_five_k_coverage` and `plot_sim_model_five_testing_proba_coverage`
    legend_coverage <- get_legend(plot_sim_model_five_R_coverage)
    
    plot_sim_model_five_R_k_testing_proba_coverage <- plot_grid(plot_sim_model_five_R_coverage +
                                                       guides(fill = "none") +
                                                       theme(plot.margin = unit(c(0,0,0,0), "in")),
                                                     plot_sim_model_five_k_coverage +
                                                       guides(fill = "none") +
                                                       theme(plot.margin = unit(c(0,0,0,0), "in")),
                                                     plot_sim_model_five_testing_proba_coverage +
                                                       guides(fill = "none") +
                                                       theme(plot.margin = unit(c(0,0,0,0), "in")),
    ...
    ggsave(plot = plot_sim_model_five_R_k_testing_proba_coverage,
...
for (ii in 1:length(n_clusters_range)) {
  ...
  for (jj in 1:length(max_cluster_size_range)) {
    ...
    plot_sim_model_five_pooled_R <- ggplot(data = data_plot_R) +
    ...
    ggsave(plot = plot_sim_model_five_pooled_R,
    ...
    plot_sim_model_five_pooled_k <- ggplot(data = data_plot_k) +
    ...
    ggsave(plot = plot_sim_model_five_pooled_k,
    ...
    plot_sim_model_five_pooled_testing_proba <- ggplot(data = data_plot_testing_proba) +
    ...
    ggsave(plot = plot_sim_model_five_pooled_testing_proba,
    ...
    # plot grid of `plot_sim_model_five_pooled_R`, `plot_sim_model_five_pooled_k` and `plot_sim_model_five_pooled_testing_proba`
    legend_sequencing_proba <- get_legend(plot_sim_model_five_pooled_R)
    
    plot_grid_sim_pooled_R_k_testing_proba <- plot_grid(plot_sim_model_five_pooled_R +
                                                          guides(color = "none") +
                                                        ...
                                                        plot_sim_model_five_pooled_k +
                                                          guides(color = "none") +
                                                          theme(plot.margin = unit(c(0,0,0.1,0.1), "in"),
                                                                axis.text.x = element_text(size = 4.5, color="black"),
                                                                axis.text.y = element_text(size = 4.5, color="black")),
                                                        plot_sim_model_five_pooled_testing_proba +
                                                          guides(color = "none") +
                                                          theme(plot.margin = unit(c(0,0,0.1,0.1), "in"),
                                                                axis.text.x = element_text(size = 4.5, color="black"),
                                                                axis.text.y = element_text(size = 4.5, color="black")),
    ...
    ggsave(filename = paste0("plots/simulation/model_five/plot_sim_model_five_R_k_testing_proba_pooled_", n_clusters_range[ii], "_", max_cluster_size_range[jj], ".pdf"),
           plot = plot_grid_sim_pooled_R_k_testing_proba,
           device = "pdf",
           width = 7.3, height = 10.7, units = c("in"),
           bg = "white")
    
    ggsave(filename = "plots/paper/pdf/figure_bayesian_validation_model_five_revised.pdf",
           plot = plot_grid_sim_pooled_R_k_testing_proba,
           device = "pdf",
           width = 7.3, height = 9, units = c("in"),
           bg = "white")
    
    ggsave(filename = "plots/paper/tiff/figure_bayesian_validation_model_five_revised_300dpi.tiff",
           plot = plot_grid_sim_pooled_R_k_testing_proba,
           device = "tiff",
    ...
    ggsave(filename = "plots/paper/tiff/figure_bayesian_validation_model_five_revised_400dpi.tiff",
           plot = plot_grid_sim_pooled_R_k_testing_proba,
           device = "tiff",
           width = 7.3, height = 9, units = "in",
           dpi = 400,
    ...
    ggsave(filename = "plots/paper/eps/figure_bayesian_validation_model_five_revised.eps",
           plot = plot_grid_sim_pooled_R_k_testing_proba,
           device = "eps",
           width = 7.3, height = 9, units = "in",
           bg = "white")
