...
# Project: R and k
# Estimate parameters from cluster data from Switzerland (model 3)
...
# run model
results_parameter_estimation <- estRodis_estimate_parameters_three(clusters_size = data_cluster_sizes_ch_month %>% pull("size"),
                                                                   ...
                                                                   sample_file = paste0("results/parameter_estimates_model_three_switzerland_", month_0, "_sample"),
                                                                   diagnostic_file = paste0("results/parameter_estimates_model_three_switzerland_", month_0, "_dia"))

# save results of parameter estimation
saveRDS(results_parameter_estimation, file = paste0("results/parameter_estimates_model_three_switzerland_", month_0, ".rds"))

# save session info
writeLines(capture.output(sessionInfo()), con = paste0("sessionInfo_model_three_switzerland_", month_0, ".txt"))
