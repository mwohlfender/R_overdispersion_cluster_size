...
# Project: R and k
# Estimate parameters from cluster data from Switzerland (model 2) (constant value for testing probability)
...
# run model
results_parameter_estimation <- estRodis_estimate_parameters_two(clusters_size = data_cluster_sizes_ch_month |> pull("size"),
                                                                 clusters_freq = data_cluster_sizes_ch_month |> pull("frequency"),
                                                                 testing_proba = testing_probas_model_two_ch_2021_months[month_0],
                                                                 ...
                                                                 sample_file = paste0("results/parameter_estimates_model_two_switzerland_", month_0, "_sample"),
                                                                 diagnostic_file = paste0("results/parameter_estimates_model_two_switzerland_", month_0, "_dia"))

# save results of parameter estimation
saveRDS(results_parameter_estimation, file = paste0("results/parameter_estimates_model_two_switzerland_", month_0, ".rds"))

# save session info
writeLines(capture.output(sessionInfo()), con = paste0("sessionInfo_model_two_switzerland_", month_0, ".txt"))
