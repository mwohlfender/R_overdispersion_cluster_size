...
write_csv(x = parameters_grid, file = path_data_sim_parameters_grid_model_one)

# write list of indices to txt file
write.table(1:nrow(parameters_grid), file = path_data_sim_indices_model_one, sep = "", append = FALSE, row.names = FALSE, col.names = FALSE)
write.table(1:nrow(parameters_grid), file = path_param_est_indices_model_one, sep = "", append = FALSE, row.names = FALSE, col.names = FALSE)
