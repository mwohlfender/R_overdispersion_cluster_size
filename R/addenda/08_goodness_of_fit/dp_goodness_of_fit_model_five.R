...
for (ii in 1:nrow(results_model_five_ch_dk_de_2021_months)) {
  
  max_cluster_size_ii <- data_cases_sequences_clusters_ch_dk_de_2021_months %>%
    filter(country == results_model_five_ch_dk_de_2021_months$country[ii],
           Month == list_months[results_model_five_ch_dk_de_2021_months$month[ii]]) %>%
    pull(Solc)
  
  data_distribution_mean_ch_dk_de_2021_month_ii <- data.frame(month = rep(x = results_model_five_ch_dk_de_2021_months$month[ii], times = max_cluster_size_ii),
                                                              country = rep(x = results_model_five_ch_dk_de_2021_months$country[ii]),
                                                              size = 1:max_cluster_size_ii,
                                                              probability = distribution_cluster_size_testing(N = max_cluster_size_ii,
                                                                                                              Re = results_model_five_ch_dk_de_2021_months$R_estimate[ii],
                                                                                                              k = results_model_five_ch_dk_de_2021_months$k_estimate[ii],
                                                                                                              p_mut = results_model_five_ch_dk_de_2021_months$mutation_proba_estimate[ii],
                                                                                                              p_detec = results_model_five_ch_dk_de_2021_months$detection_proba_estimate[ii]))
...
write_csv(x = data_distribution_mean_ch_dk_de_2021_months,
          file = path_results_goodness_fit_mean_model_five_ch_dk_de)
...
for (ii in 1:nrow(results_model_five_ch_dk_de_2021_months)) {
  ...
  data_distribution_low_ch_dk_de_2021_month_ii <- data.frame(month = rep(x = results_model_five_ch_dk_de_2021_months$month[ii], times = max_cluster_size_ii),
                                                             country = rep(x = results_model_five_ch_dk_de_2021_months$country[ii]),
                                                             size = 1:max_cluster_size_ii,
                                                             probability = distribution_cluster_size_testing(N = max_cluster_size_ii,
                                                                                                             Re = results_model_five_ch_dk_de_2021_months$R_lower_cred_int[ii],
                                                                                                             k = results_model_five_ch_dk_de_2021_months$k_upper_cred_int[ii],
                                                                                                             p_mut = results_model_five_ch_dk_de_2021_months$mutation_proba_upper_cred_int[ii],
                                                                                                             p_detec = results_model_five_ch_dk_de_2021_months$detection_proba_lower_cred_int[ii]))
...
write_csv(x = data_distribution_low_ch_dk_de_2021_months,
          file = path_results_goodness_fit_low_model_five_ch_dk_de)
...
for (ii in 1:nrow(results_model_five_ch_dk_de_2021_months)) {
  ...
  data_distribution_high_ch_dk_de_2021_month_ii <- data.frame(month = rep(x = results_model_five_ch_dk_de_2021_months$month[ii], times = max_cluster_size_ii),
                                                              country = rep(x = results_model_five_ch_dk_de_2021_months$country[ii]),
                                                              size = 1:max_cluster_size_ii,
                                                              probability = distribution_cluster_size_testing(N = max_cluster_size_ii,
                                                                                                              Re = results_model_five_ch_dk_de_2021_months$R_upper_cred_int[ii],
                                                                                                              k = results_model_five_ch_dk_de_2021_months$k_lower_cred_int[ii],
                                                                                                              p_mut = results_model_five_ch_dk_de_2021_months$mutation_proba_lower_cred_int[ii],
                                                                                                              p_detec = results_model_five_ch_dk_de_2021_months$detection_proba_upper_cred_int[ii]))
...
write_csv(x = data_distribution_high_ch_dk_de_2021_months,
          file = path_results_goodness_fit_high_model_five_ch_dk_de)
